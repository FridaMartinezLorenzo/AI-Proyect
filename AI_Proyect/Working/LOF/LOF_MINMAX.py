...
y_train = train_data['Label'].values  # Convertir a numpy array
X_test = test_data.drop(columns=['Label'])
y_test = test_data['Label'].values  # Convertir a numpy array
...
print(y_test)  # y_test ya es un arreglo de numpy
